...
import { toast } from "react-toastify";   // alerts about wrong info
...
<input
  ...
  className="w-full px-4 py-2 border border-gray-300 rounded-full bg-black text-white focus:outline-none focus:ring-1 focus:ring-gray-400"
/>
        <button
          type="submit"
